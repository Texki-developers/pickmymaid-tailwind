...
export default async function Wishlist() {
    ...
    const maids = data?.data?.favorites?.map((item: any) => ({
        option: item.option,
        id: item._id,
    ...
    console.log({ maids }, "this is the miad........favorites");
        ...
        <>
            <div className="w-full h-max py-2 md:py-8 px-4 md:px-6 lg:px-8 2xl:px-32">
                <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
                    {maids?.length > 0 ? (
                        <>
                            <h1 className="w-full text-left text-2xl md:text-3xl font-semibold">Your Favorite Maids/Nannies</h1>
                        ...
                        <div className="min-h-[80vh] flex items-center justify-center">
                            <div className="flex flex-col items-center gap-3 text-center">
                                ...
                                <p className="text-gray-600">Your favorites list is empty. Start adding items to see them here!</p>
                                <Link
                                    href="/search"
