...
export default function PressAppearanceWrapper() {
  ...
  return (
    ...
    //   <Grid
    //     w="100%"
    //     templateColumns={{ base: "1fr", sm: "1fr 1.5fr", lg: "1fr 1fr" }}
    //     gap={{ base: 4, sm: "5%", md: "5%" }}>
    //     <Hide below="md">
    //       <Box
    //         onClick={() =>
    //           router.push(
    ...
    //         We are thrilled to be recognized by Khaleej Times for achieving a significant milestone—helping over 5,900 maids find employment in the UAE!
    //         <br />
    //         <br />
    //         At Pickmymaid, our mission is simple: to connect skilled domestic workers with families in need of reliable household help. Through our seamless
    //         online platform, we make the hiring process easier, faster, and more transparent for both employers and workers.
    //         <br />
    //         <br />
    //         "Our platform is designed to create a win-win situation—offering employment opportunities while simplifying the hiring process for UAE residents." —
    //         Mohammed Ibrahim, Manager of Pickmymaid
    //         <br />
    //         <br />
    //         This feature highlights our dedication to revolutionizing the domestic help industry in the UAE. As we continue to grow, we remain committed to
    //         providing trusted, efficient, and ethical solutions for families and domestic workers alike.
    //         <br />
    //         <br />
    //         Looking for a reliable maid? {/* TODO: enable link */}
    //         <Link href="/search" style={{ color: "blue" }}>
