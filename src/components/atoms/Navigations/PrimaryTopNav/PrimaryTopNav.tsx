"use client";
import { Avatar, Button, Flex, Link as ChakraLink, HStack, Menu, Image as ChakraImage, MenuButton, MenuItem, MenuList, Show, Text } from "@chakra-ui/react";
...
import { logoutUser, verifyAuthentication } from "@/lib/features/auth/authAction";
      ...
      <Show above="lg">
        <HStack gap={{ base: 2, xl: 5 }}>
            ...
            <Fragment key={navItem.name}>
              {!navItem.name.includes("hiringTips") && (
                <ChakraLink
                  ...
                  color={pathname === navItem.path || pathname === `${navItem.path}/` ? "brand.primary.300" : "text.black.700"}
                  key={navItem.name}
          ...
          <Button
            ...
            onClick={() => handleLanguageSwitching(i18n.dir() === "ltr" ? "ar" : "en")}>
            {i18n.dir() === "ltr" ? (
              <>
                عربي
                <Image
