import { Badge, Box, Button, Divider, Grid, HStack, Heading, Icon, Link, SimpleGrid, Text, VStack, useToast } from "@chakra-ui/react";
    ...
    <div
      ...
      <div className="w-full grid gap-2 pt-4!">
        <div className="flex justify-between items-center">
          {postedDate && <p className="text-sm font-medium">{`Posted on ${moment(postedDate).format("DD-MM-yyyy")}`}</p>}
          <div className="flex ">
            {nationality && (
        ...
        <div className="flex justify-between gap-2 items-center">
          <div className="text-sm px-2! py-1! rounded-md bg-red-100">{experience > 1 ? `${experience} Years+ experience` : "1 Year experience"}</div>
          <div className="flex gap-2 items-center">
